...
<head>
        <meta charset="utf-8" />
        <title>Siswa Nonaktif| <?php echo $app;?></title>
                        ...
                        <div class="row">
                            <div class="col-4">                           
                                    ...
                                    <div class="col-3">  
                                        ...
                                        <a class="btn btn-info waves-effect waves-light" role="button" href="m_student">Aktif (1)</a>
                                        <a class="btn btn-secondary waves-effect waves-light" role="button" href="#">Nonaktif (1)</a>
  ...
  <div class="row">
                                <div class="col-12">
                                    <div class="card-box table-responsive">
                                        <h4 class="header-title">Data Siswa NonAktif</h4>
    ...
    <?php
               ...
               $sql    = "select * from student where status='inactive' order by student_id";
                                               ...
                                               <td><?php echo mysqli_real_escape_string($conn,$fill['status']);?></td>
                                                  ...
                                                  <td>
                                                     ...
                                                     <a href="m_student_add?id=<?php echo $fill['student_id'];?>" class="btn btn-icon waves-effect waves-light btn-purple"> <i class="fa fa-wrench"></i> </a>
                                                         ...
                                                         <button type="button" class="btn btn-icon waves-effect waves-light btn-info" > <i class="fas fa-eye"></i> </button>
                                                    ...
                                                    <?php } ?>
                                                        ...
                                                        <button type="button" class="btn btn-small btn-icon waves-effect waves-light btn-danger" onclick="window.location.href='component/delete/delete_biasa?no=<?php echo $fill['student_id'].'&'; ?>forward=<?php echo "barang".'&';?>forwardpage=<?php echo $halaman.'&'; ?>chmod=<?php echo $chmod; ?>'"> <i class="fas fa-times"></i> </button>
                                                      <?php } ?>
