                        ...
                        <div class="col-12">
                            <div class="card-box">
                                ...
                                <div class="table-responsive">
                                    ...
                                    $sql = "SELECT
                                        uang_masuk_keluar.no,
                                        uang_masuk_keluar.tipe,
                                        uang_masuk_keluar.nama,
                                        uang_masuk_keluar.keterangan,
                                        uang_masuk_keluar.jumlah,
                                        uang_masuk_keluar.kasir,
                                        uang_masuk_keluar.kategori_id,
                                        uang_masuk_keluar.student_id,
                                        uang_masuk_keluar.period_id,
                                        uang_masuk_keluar.bebas_id,
                                        uang_masuk_keluar.bulanan_id,
                                        uang_masuk_keluar.tabungan_id,
                                        uang_masuk_keluar.tgl_update,
                                        uang_masuk_keluar.tgl_input,
                                        uang_masuk_keluar.jenis_pembayaran,
                                        student.nis,
                                        student.nama as nama_siswa,
                                        class.kelas as nama_kelas
                                    FROM uang_masuk_keluar 
                                    LEFT JOIN student on student.student_id = uang_masuk_keluar.student_id 
