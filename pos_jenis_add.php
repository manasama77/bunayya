              ...
              <div class="col-lg-6">
                <div class="card-box">
                  ...
                  <div class="table-responsive">
                    ...
                    <div class="col-md-12">
                      <div class="form-group no-margin">
                        <label for="tipe" class="control-label">Tipe Bayar*</label>
                        <select class="form-control" id="tipe" name="tipe">
                          <option <?= ($a['jenis_pembayaran'] == "bulanan") ? "selected" : null; ?> value="bulanan">BULANAN</option>
                          <option <?= ($a['jenis_pembayaran'] == "bebas") ? "selected" : null; ?> value="bebas">BEBAS</option>
                        </select>
                      </div>
