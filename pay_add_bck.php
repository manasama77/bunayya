...
<!-- ISI HALAMAN -->
      ...
      ?>
                                                    ...
                                                    <div class="form-group mr-2">
                                                        <label for="exampleInputEmail2" class="mr-2">NIS</label>
                                                        <input type="text" class="form-control" id="nis" name="s" placeholder="1111" autocomplete="off">
                                                    </div>
                            ...
                            <div class="col-9">
                              ...
                              <div class="col-3">
                                <div class="card-box">
                                     ...
                                     <img src="student/<?php echo $trimmed;?>" alt="image"
