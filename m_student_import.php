                       ...
                       <th>Hobi</th>
                        ...
                        foreach ($worksheet->getRowIterator() as $row) { // Lakukan perulangan dari data yang ada di csv
                            ...
                            if ($numrow > 1) {
                                ...
                                if ($nis == "" or $nisn == "" or $nama == "" or $gender == "" or $tempat == "" or $tgllahir == "" or $hobi == "" or $nohp == "" or $ibu == "" or $ayah == "" or $waortu == "" or $alamat == "" or $kelas == "" or $email == "") {
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    if ($trun1) {
                        ...
                        echo "<script type='text/javascript'>  alert('GAGAL, Data siswa gagal di reset seluruhnya. Terjadi kesalahan dalam proses reset. Ulangi lagi dan pastikan internet anda stabil');</script>";
                    }
                } else {
