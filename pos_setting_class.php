            ...
            while ($row = mysqli_fetch_assoc($query)) {
                ...
                while ($i <= 11) {
                    ...
                    if (mysqli_num_rows($cek) > 0) {
                        ...
                        $sqlnya = "INSERT INTO bulanan VALUES(null, '$period', '$murid', '$jenis', '$i', '$bulan', 'belum', '0', '" . $row_biaya_admin['biaya'] . "', '$user', '$now')";
                        $sql = mysqli_query($conn, $sqlnya);
                    }
                }
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="card-box">
                            ...
                            <form class="form-horizontal" method="post" action="pos_setting_class">
