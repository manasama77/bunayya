...
<head>
        <meta charset="utf-8" />
        <title>Alumni | <?php echo $app;?></title>
...
<strong>Berhasil!</strong> Data alumni telah disimpan</div>
  ...
  <div class="row">
                                <div class="col-12">
                                    <div class="card-box table-responsive">
                                        ...
                                        <p class="sub-header">
                                            Daftar Alumni ditampilkan dengan secara dinamis untuk mempermudah administrasi. <code>Gunakan Tombol Copy,Excel dan PDF untuk Export data ke Aplikasi lain</code>
                                        </p>
    ...
    <?php
               ...
               $sql    = "select * from student_alumni where status='lulus' order by student_id";
                                               ...
                                               <td><?php echo mysqli_real_escape_string($conn,$fill['status']);?></td>
                                                  ...
                                                  <td>
                                                     ...
                                                     <?php  if ($chmod >= 3 || $_SESSION['jabatan'] == 'admin') { ?>
                                                         ...
                                                         <a href="m_alumnus_detail?id=<?php echo $fill['student_id'];?>" class="btn btn-icon waves-effect waves-light btn-info" > <i class="fas fa-eye"></i> </a>
                                                    ...
                                                    <?php } ?>
                                                        ...
                                                        <button type="button" class="btn btn-small btn-icon waves-effect waves-light btn-danger" onclick="window.location.href='component/delete/delete_alumni?no=<?php echo $fill['student_id'];?>&forwardpage=<?php echo $forwardpage;?>&forward=<?php echo $forward;?>'"> <i class="fas fa-times"></i> </button>
                                                      <?php } ?>
