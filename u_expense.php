...
<head>
    <meta charset="utf-8" />
    <title>Pengeluaran | <?php echo $app; ?></title>
    ...
    $halaman = "u_expense"; // halaman
    $dataapa = "Pengeluaran"; // data
    $tabeldatabase = "uang_keluar"; // tabel database
                ...
                <div class="row">
                    <div class="col-2">
                        <?php if ($chmod >= 3 || $_SESSION['jabatan'] == 'admin') { ?>
                            <button type="button" class="btn btn-info waves-effect waves-light" data-toggle="modal" data-target="#pengeluaran">Tambah Pengeluaran</button>
                        <?php } ?>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card-box">
                            ...
                            $q = $_GET['q'];
                            if ($q != '' || $q != null) {
                                $sql    = "select * from uang_masuk_keluar WHERE tipe='out' and kategori_id not in (1, 2, 9998, 9999) AND nama like '%$q%' or keterangan like '%$q%' order by tgl_input desc";
                            } else {
                                $sql    = "select * from uang_masuk_keluar WHERE tipe='out' and kategori_id not in (1, 2, 9998, 9999) order by tgl_input desc";
                            }
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="field-3" class="control-label">Nama Pengeluaran</label>
                                    <input type="text" class="form-control" id="field-3" name="nama" required autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="field-3" name="jumlah" required autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" data-toggle="select2" style="width: 100%;" name="kate" id="kate">
                                        ...
                                        <?php
                                        $sql = mysqli_query($conn, "select * from uang_kategori where jenis='out' and kategori_id not in (1, 2, 9998, 9999)");
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="datepicker form-control" value="<?php echo $today; ?>" id="datepicker" name="tgl" autocomplete="off">
                                </div>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="expense" class="btn btn-info waves-effect waves-light">Simpan</button>
    ...
    if (isset($_POST['expense'])) {
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql = "INSERT INTO uang_masuk_keluar VALUES('', 'out', '$nama', '$ket', '$jml', '$user', '$kate', '', '', '', '', '', '$tgl', '$now', 'cash')";
