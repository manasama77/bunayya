...
$dataapa = "Laporan Pembayaran"; // data
...
<!-- ISI HALAMAN -->
                                             ...
                                             <div class="col-lg-9">
                                                ...
                                                <form class="form-inline" method="get">
                                                    <div class="form-group mr-2">
                                                       ...
                                                       <select style="width: 200px" name="t" onchange="this.form.submit()">
                                                        <option >Pilih</option>
                                                            <?php
         $t=$_GET['t'];
        ...
        while ($row=mysqli_fetch_assoc($sql)){
          if ($_GET['t']==$row['no'])
          echo "<option value='".$row['no']."' selected='selected'>".$row['period_name']."</option>";
          else
          echo "<option value='".$row['no']."' >".$row['period_name']."</option>";
        }
      ?>
                                                    ...
                                                    <div class="form-group mr-2">
                                                        <label for="exampleInputEmail2" class="mr-2">Pos Pembayaran</label>
                                                      <select style="width: 200px" name="j">
                                                            <?php
       
        $sql=mysqli_query($conn,"select * from jenis_bayar where jenis_pembayaran='bebas' AND period_id='$t' order by jenis_id desc");
        while ($row=mysqli_fetch_assoc($sql)){
          if ($t==$row['period_id'])
          echo "<option value='".$row['jenis_id']."' selected='selected'>".$row['nama']. ' | ' .$row['tahunajar']."</option>";
          else
          echo "<option value='".$row['jenis_id']."' >".$row['nama']. ' | ' .$row['tahunajar']."</option>";
