...
<strong>Gagal!</strong> Data Siswa dengan NIS yang sama sudah ada! Gunakan NIS yang berbeda</div>
<?php } else if($msg=="error"){?>
<div id="myAlert" class="alert alert-danger text-danger alert-dismissible fade show" role="alert">
<button type="button" class="close" data-dismiss="alert" aria-label="Close">
<span aria-hidden="true">&times;</span> </button>
<strong>GAGAL UPDATE!</strong> id hilang, silahkan kembali ke halaman utama dan coba lagi</div>
<?php } ?>
...
if((($tipeavatar == "image/jpeg" || $tipeavatar == "image/png") && ($ukuranavatar <= 10000000)) && ( $chmod >= 2 || $_SESSION['jabatan'] == 'admin')){
  ...
  $sql2 = "UPDATE student SET nis='$nis',nisn='$nisn',nama='$nama',gender='$gender',birth_place='$tempat',birth_date='$tgllahir',avatar='$avatar',nohp='$nohp',hobi='$hobi',alamat='$alamat',ibu='$ibu',ayahwali='$ayah',waortu='$wa',kelas_id='$kelas',catatan='$cat',status='$status',last_update='$now' WHERE student_id='$id' ";
  ...
  $sql2 = "UPDATE student SET nis='$nis',nisn='$nisn',nama='$nama',gender='$gender',birth_place='$tempat',birth_date='$tgllahir',nohp='$nohp',hobi='$hobi',alamat='$alamat',ibu='$ibu',ayahwali='$ayah',waortu='$wa',kelas_id='$kelas',catatan='$cat',status='$status',last_update='$now' WHERE student_id='$id' ";
...
<div class="col-lg-3 col-xs-12">
                                <div class="card-box">
                                    <h4 class="header-title">Foto</h4>
                                                 ...
                                                 <div class="col-12">
                                                    <img id="blah" src="student/<?php echo $trimmed;?>" alt="image"
...
<button type="button" class="close" data-dismiss="alert" aria-label="Close">
<span aria-hidden="true">&times;</span> </button>
Setelah Data Siswa disimpan, maka siswa tersebut bisa login ke Aplikasi untuk pertama kalinya memakai NIS dan password standar 123456</div>
