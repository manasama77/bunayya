...
<body class="authentication-bg bg-primary authentication-bg-pattern d-flex pb-0 vh-100">
...
<div class="account-pages w-100 mt-6 mb-6">
        <div class="container">
            <div class="row justify-content-center">
             ...
             <h4 class="text-uppercase mb-1 mt-4 text-center">Smart Payment - Aplikasi Manajemen Pembayaran YAYASAN PENDIDIKAN DAAR EL KHAER
</h4>
