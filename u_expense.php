...
<strong>Gagal!</strong> Sudah ada Kategori dengan nama yang sama</div>
<?php } else if($msg=="false"){?>
<div id="myAlert" class="alert alert-danger text-danger alert-dismissible fade show" role="alert">
<button type="button" class="close" data-dismiss="alert" aria-label="Close">
<span aria-hidden="true">&times;</span> </button>
<strong>GAGAL!</strong> Terjadi kesalahan, Hubungi Admin jika perlu</div>
<?php } else if($msg=="true"){?>
<div id="myAlert" class="alert alert-success text-success alert-dismissible fade show" role="alert">
<button type="button" class="close" data-dismiss="alert" aria-label="Close">
<span aria-hidden="true">&times;</span> </button>
<strong>Berhasil!</strong> Data telah disimpan</div>
...
<?php } ?>
 ...
 <div class="row">
              ...
              $q=$_GET['q'];
              if ($q!='' || $q !=null){
               $sql    = "select * from uang_masuk_keluar WHERE tipe='out' AND nama like '%$q%' or keterangan like '%$q%' order by tgl_input desc";
             } else {
