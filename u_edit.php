              ...
              <div class="card-box">
                ...
                <div class="table-responsive">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="datepicker" value="<?php echo $a['tgl_update']; ?>" name="tgl">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control" data-toggle="select2" style="width: 100%;" name="kate" id="kate">
                      ...
                      <?php
                      $sql = mysqli_query($conn, "select * from uang_kategori where jenis='$jenis' and kategori_id not in (1, 2, 9998, 9999)");
                      while ($row = mysqli_fetch_assoc($sql)) {
                        $selected = "";
                        if ($a['kategori_id'] == $row['kategoori_id']) {
                          $selected = 'selected="selected"';
                        }
                        echo "<option value='" . $row['kategori_id'] . "' $selected>" . $row['nama'] . "</option>";
                      }
                      ?>
